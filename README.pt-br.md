...
- Uma versão do projeto dividida em microsserviços pode ser encontrada na [branch "microservices"](https://github.com/WesleyMime/Financial-Transaction-Analyzer/tree/microservices) e é a versão atualmente em produção.
