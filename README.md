...
- A version of the project divided into microservices can be found in the ["microservices" branch](https://github.com/WesleyMime/Financial-Transaction-Analyzer/tree/microservices) and is the deployed version.
